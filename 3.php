        ...
        <section id="details">
            <div class="container">
                <form method="POST" action="kit.php">
                    <h2 id="heading" style="margin-left: 20.5em">TENNIS KIT</h2>
                     <div>
                        <label>Kit</label>
                        <select name="kit" style="width: 174px">
                            <option value="ball">Tennis Ball</option>
                    ...
                    <br>
                     <div>
                        ...
                        <select name="brand" style="width: 174px">
                            ...
                            <option value="locoste">Lacoste</option>
                   ...
                   <div>
                    ...
                    <script>
                        function myFunction(){
                            document.getElementById("price").defaultValue = "1150";
                        }
                    </script>
